    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-48 h-48 rounded-full bg-gradient-primary opacity-20 blur-3xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-32 h-32 rounded-full bg-gradient-secondary opacity-15 blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-32 left-1/4 w-24 h-24 rounded-full bg-gradient-accent opacity-25 blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-20 right-1/3 w-16 h-16 rounded-full bg-gradient-primary opacity-40 blur-lg animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        </div>
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-body-lg text-white/80 mb-8 max-w-2xl mx-auto">
              Get AI-powered recommendations based on your trading style, backed by comprehensive data analysis and real user reviews.
            </p>
          </div>

          {/* Hero Recommender Form */}
